...
win.title("GG's Net Banking")
win.iconbitmap("D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\bitmap_5.ico")
...
def win_login():
    ...
    win3.iconbitmap("D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\bitmap_4.ico")
    ...
    idk = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\login.png")
    ...
    def db_signin():
        ...
        if result:
            ...
            win4.iconbitmap("D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\bitmap_4.ico")
...
img_fb = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\fb_s.png")
...
img_tw = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\twitter_s.png")
...
img_insta = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\insta_s.png")
...
img_yt = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\yt_s.png")
...
img_reg = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\regis.png")
...
img_login = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\login.png")
...
img_msg = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\msg.png")
...
img_gg = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\gg.png")
...
img_home = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\home.png")
...
img_edit=PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\edit.png")
...
img_user = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\user_1.png")
...
img_contact = PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\contact_1.png")
...
img_pizza=PhotoImage(file="D:\\GG's Doc\\Programming\\Python\\GUI\\Icons\\pizza.png")
